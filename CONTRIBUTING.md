...
[`contract/relate.ward`](contract/relate.ward) is the machine-checkable half: a
tier list, low to high, where an import may only point back up the page. If your
change needs a new import edge, edit the contract in the same commit and say why
in the exception. Do not route around it.
